...
namespace Com.Radaee.View {
	...
	public partial class PDFVFinder : global::Java.Lang.Object {
		...
		[Register (".ctor", "()V", "")]
		protected PDFVFinder () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (PDFVFinder)) {
				SetHandle (
...
#pragma warning restore 0169
		...
		protected virtual void Find_draw (global::Android.Graphics.Canvas p0, global::Com.Radaee.View.PDFVPage p1, int p2, int p3)
		{
			...
			if (GetType () == ThresholdType)
				JNIEnv.CallVoidMethod  (Handle, id_find_draw_Landroid_graphics_Canvas_Lcom_radaee_view_PDFVPage_II, new JValue (p0), new JValue (p1), new JValue (p2), new JValue (p3));
			else
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "find_draw", "(Landroid/graphics/Canvas;Lcom/radaee/view/PDFVPage;II)V"), new JValue (p0), new JValue (p1), new JValue (p2), new JValue (p3));
		}
...
#pragma warning restore 0169
		...
		protected virtual void Find_draw (global::Com.Radaee.Pdf.BMP p0, global::Com.Radaee.View.PDFVPage p1, int p2, int p3)
		{
			...
			if (GetType () == ThresholdType)
				JNIEnv.CallVoidMethod  (Handle, id_find_draw_Lcom_radaee_pdf_BMP_Lcom_radaee_view_PDFVPage_II, new JValue (p0), new JValue (p1), new JValue (p2), new JValue (p3));
			else
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "find_draw", "(Lcom/radaee/pdf/BMP;Lcom/radaee/view/PDFVPage;II)V"), new JValue (p0), new JValue (p1), new JValue (p2), new JValue (p3));
		}
...
#pragma warning restore 0169
		...
		protected virtual void Find_draw_to_dib (global::Com.Radaee.Pdf.DIB p0, global::Com.Radaee.View.PDFVPage p1, int p2, int p3)
		{
			...
			if (GetType () == ThresholdType)
				JNIEnv.CallVoidMethod  (Handle, id_find_draw_to_dib_Lcom_radaee_pdf_DIB_Lcom_radaee_view_PDFVPage_II, new JValue (p0), new JValue (p1), new JValue (p2), new JValue (p3));
			else
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "find_draw_to_dib", "(Lcom/radaee/pdf/DIB;Lcom/radaee/view/PDFVPage;II)V"), new JValue (p0), new JValue (p1), new JValue (p2), new JValue (p3));
		}
